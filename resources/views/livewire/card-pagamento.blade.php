    ...
    @elseif($etapa == 3)
        <div id="3"
            ...
            <div class="flex items-center justify-center w-full mt-2">
                ...
                <a href="https://api.whatsapp.com/send?phone=5514997077987&text=Olá. Realizei o pagamento da {{$evento->titulo}}, poderia verificar? Por favor." target="_blank">
        ...
        <div id="4"
            ...
            <div class="my-4 w-full rounded-lg px-2 py-2 md:ml-5 text-left">
                ...
                @if ($user->totalDescontoEvento($evento) > 0)
                    <p class="text-orange-400 drop-shadow-md">Desconto: R${{ $user->totalDescontoEventoFormatado($evento) }}</p>
                @endif
