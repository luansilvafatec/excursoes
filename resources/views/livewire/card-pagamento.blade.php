    ...
    @elseif($etapa == 3)
        <div id="3"
            ...
            <div class="flex items-center justify-center w-full mt-2">
                ...
                <a href="https://api.whatsapp.com/send?phone=5514997077987&text=Olá. Realizei o pagamento da {{ $evento->titulo }}, poderia verificar? Por favor."
                    target="_blank">
        ...
        <div id="4"
            ...
            <div class="my-4 w-full rounded-lg px-2 py-2 md:ml-5 text-left">
                ...
                @if ($user->totalDescontoEvento($evento) > 0)
                    <p class="text-orange-400 drop-shadow-md">Desconto:
                        R${{ $user->totalDescontoEventoFormatado($evento) }}</p>
                @endif
    ...
    @elseif ($etapa == 6)
        <div id="6"
            ...
            <p class="mt-4">Não fique triste, você ainda pode ter chances de ir! Entre para a lista de espera e te
                avisaremos caso apareça alguma vaga.</p>


            <button wire:click="aviseMe"
                class="mt-10 p-4 font-bold text-2xl rounded-md my-auto bg-[#00897B]">Avise-me!</button>
        </div>
    @elseif ($etapa == 7)
        <div id="7"
            class="flex flex-col items-center justify-center h-full transition ease-out duration-700 transform opacity-100"
